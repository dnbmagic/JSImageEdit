...
function generateFormDataUpload (file, opts) {
...
const generateBareUpload = file => file.data
...
export default class MiniXHRUpload {
  ...
  #addEventHandlerForFile (eventName, fileID, eventHandler) {
    this.uploaderEvents[fileID].on(eventName, (fileOrID) => {
      ...
      // We generated a generic `addEventListenerForFile` but not all events
  ...
  uploadLocalFile (file) {
    ...
    return new Promise((resolve, reject) => {
      ...
      const data = opts.formData
        ? generateFormDataUpload(file, opts)
        : generateBareUpload(file, opts)
