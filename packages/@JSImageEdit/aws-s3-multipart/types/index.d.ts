import type { BasePlugin, Pluginopts, UppyFile } from '@uppy/core'
...
type AWSS3WithoutCompanion = {
  ...
  getTemporarySecurityCredentials?: (opts?: {
    signal?: AbortSignal
  }) => MaybePromise<AwsS3STSResponse>
}

interface _AwsS3Multipartopts extends Pluginopts {
  allowedMetaFields?: string[] | null
  limit?: number
  retryDelays?: number[] | null
}

export type AwsS3Multipartopts = _AwsS3Multipartopts &
  (
...
declare class AwsS3Multipart extends BasePlugin<AwsS3Multipartopts> {}
