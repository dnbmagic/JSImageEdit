...
- @uppy/aws-s3-multipart: aws-s3-multipart - call `#setCompanionHeaders` in `setopts` (jur-ng / #4687)
...
- @uppy/aws-s3-multipart: allow `companionHeaders` to be modified with `setopts` (Paulo Lemos Neto / #3770)
...
- @uppy/aws-s3-multipart: export interface AwsS3Multipartopts (Matteo Padovano / #3709)
